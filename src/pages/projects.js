...
const FeaturedProject=({type,title,summary,img,link,github})=>{
    ...
    return (
        ...
        rounded-3xl border border-solid border-dark dark:border-light bg-light dark:bg-dark dark:text-light shadow-2xl p-12 relative 
        rounded-br-2xl lg:flex-col lg:p-8 xs:rounded-2xl xs:rounded-br-3xl xs:p-4
        '>
            ...
            <div className='w-1/2 flex flex-col items-start justify-between pl-6 lg:w-full lg:pl-0 lg:pt-6'>
                ...
                <Link href={link} target='_blank' className='hover:underline underline-offset-2'>
                    <h2 className='my-2 w-full text-3xl font-bold sm:text-sm '>{title}</h2>
                </Link>
                ...
                dark:bg-light dark:text-dark dark:hover:bg-dark dark:hover:text-light sm:px-4 sm:text-base
                '>
                    Visit Project
                </Link>
                </div>
...
const projects = () => {
  return (
    <>
        <Head>
            <title>MSRS | Projetcs Page</title>
