      ...
      {/* For Mobile Link */}
        {
            ...
            ">
              ...
              <nav className="flex items-center justify-center flex-wrap mt-2">
                <motion.a
                  href="https://twitter.com/Saifur240"
                  target={"_blank"}
                  whileHover={{ y: -2 }}
                  whileTap={{ scale: 0.9 }}
                ...
                <motion.a
                  href="https://github.com/saifur111"
                  target={"_blank"}
                  whileHover={{ y: -2 }}
                  whileTap={{ scale: 0.9 }}
                  className="w-6 mr-3 bg-light sm:mx-1 dark:bg-dark rounded-full"
                >
                  <GithubIcon />
                </motion.a>
                <motion.a
                  href="https://www.linkedin.com/in/msrs2hin/"
                  target={"_blank"}
                  className="w-6 mr-3 bg-light sm:mx-1 dark:bg-dark rounded-full"
                  whileHover={{ y: -2 }}
                  whileTap={{ scale: 0.9 }}
